                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {['Border Only', 'Butta / Motifs Only', 'Border & Butta', 'Overall Design'].map(loc => (
                            <button
                                ...
                                className={`text-xs py-2 px-3 rounded-md border text-center transition-colors ${
                                    config.stoneWorkLocation === loc 
                    ...
                    <div className="grid grid-cols-4 gap-1">
                        {['None', 'Sober', 'Medium', 'Heavy'].map((level) => (
                            <button
                                ...
                                className={`py-2 px-1 text-xs rounded-md border text-center transition-colors font-semibold ${
                                    config.jewelleryLevel === level 
